...
public class SeedData implements ApplicationRunner {
    ...
    public SeedData(JdbcClient jdbc, PasswordEncoder encoder,
                    @Value("${asterism.initial-admin-password:}") String configuredAdminPassword,
                    @Value("${asterism.seed-demo-data:false}") boolean seedDemoData,
                    @Value("${asterism.demo-password:}") String demoPassword) {
        this.jdbc = jdbc;
