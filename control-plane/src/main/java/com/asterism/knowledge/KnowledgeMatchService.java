...
public class KnowledgeMatchService {
    ...
    public MatchResult match(String systemId, List<String> anchors) {
        ...
        var targets = jdbc.sql("""
                        select entry_id, repo_id, kind, title, anchor_texts, route_path, api_endpoints::text, code_refs::text,
                ...
                .query((rs, rowNum) -> new SuspectedTarget(
                        ...
                        rs.getString("anchor_texts").lines().filter(value -> !value.isBlank()).toList(),
    ...
    public record SuspectedTarget(String entryId, String repo, String kind, String title, List<String> anchorTexts,
                                  String routePath,
                                  List<String> apiEndpoints, List<String> codeRefs, double confidence) {
        public SuspectedTarget {
            anchorTexts = anchorTexts == null ? List.of() : List.copyOf(anchorTexts);
        }

        public SuspectedTarget(String entryId, String repo, String kind, String title, String routePath,
                               List<String> apiEndpoints, List<String> codeRefs, double confidence) {
            this(entryId, repo, kind, title, List.of(), routePath, apiEndpoints, codeRefs, confidence);
        }

        public SuspectedTarget(String entryId, String kind, String title, String routePath,
                               List<String> apiEndpoints, List<String> codeRefs, double confidence) {
            this(entryId, "main", kind, title, List.of(), routePath, apiEndpoints, codeRefs, confidence);
        }
    }
