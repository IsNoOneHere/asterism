...
public class ProjectionService {
    ...
    private static final Map<String, LifecycleStatus> EVENT_TARGETS = Map.ofEntries(
            ...
            Map.entry("ModificationCheckpointRestored", LifecycleStatus.modification_completed),
            Map.entry("PatchCheckpointRestored", LifecycleStatus.patch_applied),
            Map.entry("ValidationCheckpointRestored", LifecycleStatus.validation_passed),
