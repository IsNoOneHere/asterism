...
public final class IntegrationDatabase {
    private static final String LOCAL_URL = "jdbc:postgresql://localhost:55432/asterism?stringtype=unspecified&currentSchema=control_plane_v5,public";
    private static final String USER = "asterism";
    private static final String PASSWORD = "asterism";
