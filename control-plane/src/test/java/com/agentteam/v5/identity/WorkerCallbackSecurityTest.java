...
import com.agentteam.v5.event.ProjectionController;
import com.agentteam.v5.memory.MemoryController;
import com.agentteam.v5.memory.ContextManifestService;
...
@TestPropertySource(properties = "agent-team.worker-callback.token=test-worker-token")
