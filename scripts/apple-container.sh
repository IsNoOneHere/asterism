...
prepare_env() {
  ...
  export V5_CLAUDE_MAX_TURNS V5_RELEASE_PUSH V5_PUBLIC_URL V5_PROFILE
...
up_services() {
  ...
  run_external_service worker \
    ...
    --env V5_PLANNER_PROVIDER --env V5_PLANNER_HTTP_ENDPOINT --env V5_AGENT_SERVICE_URL --env V5_RELEASE_PUSH --env V5_WORKSPACE_ROOT --env V5_PUBLIC_URL \
