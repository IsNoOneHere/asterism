...
SERVER_RELEASE_IMAGE="ghcr.io/isnoonehere/asterism-server:${ASTERISM_VERSION:-0.1.6}"
RUNNER_RELEASE_IMAGE="ghcr.io/isnoonehere/asterism-runner:${ASTERISM_VERSION:-0.1.6}"
...
prepare_env() {
  ...
  V5_PRODUCT_AGENT_HTTP_TIMEOUT_SECONDS="${V5_PRODUCT_AGENT_HTTP_TIMEOUT_SECONDS:-660}"
  V5_AGENT_MODEL_REQUEST_TIMEOUT_SECONDS="${V5_AGENT_MODEL_REQUEST_TIMEOUT_SECONDS:-600}"
  ...
  export V5_AGENT_MODEL V5_AGENT_BASE_URL V5_AGENT_API_KEY V5_AGENT_WORKER_CALLBACK_TOKEN V5_AGENT_MODEL_REQUEST_TIMEOUT_SECONDS
  ...
  export V5_ENGINE_MAX_TURNS V5_ENGINE_TIMEOUT_SECONDS V5_ENGINE_EFFORT_LEVEL V5_PRODUCT_AGENT_HTTP_TIMEOUT_SECONDS
...
up_services() {
  ...
  run_external_service runner \
    ...
    --env V5_ARTIFACTS_ROOT --env V5_AGENT_SERVICE_URL --env V5_PRODUCT_AGENT_HTTP_TIMEOUT_SECONDS \
    --env V5_RELEASE_PUSH --env V5_WORKSPACE_ROOT --env V5_PUBLIC_URL \
    --env V5_AGENT_MODEL --env V5_AGENT_BASE_URL --env V5_AGENT_API_KEY --env V5_AGENT_MODEL_REQUEST_TIMEOUT_SECONDS \
  ...
  export V5_DB_URL V5_PRODUCT_AGENT_URL V5_ATTACHMENT_ROOT
  ...
  run_service server \
    ...
    --env V5_PRODUCT_AGENT_URL --env V5_ATTACHMENT_ROOT \
