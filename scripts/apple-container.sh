...
up_services() {
  ...
  run_service control-plane \
    ...
    --env ASTERISM_GITLAB_BASE_URL --env ASTERISM_GITLAB_TOKEN \
    --publish 8085:8085 \
  ...
  export V5_CONTROL_PLANE_URL V5_AGENT_SERVICE_URL
  ...
  run_external_service worker \
    ...
    --env V5_WORKER_CALLBACK_TOKEN --env V5_EXECUTION_ENGINE \
    ...
    --env V5_ARTIFACTS_ROOT \
    --env V5_AGENT_SERVICE_URL --env V5_RELEASE_PUSH --env V5_WORKSPACE_ROOT --env V5_PUBLIC_URL \
